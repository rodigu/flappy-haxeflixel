...
@:keep @:font("/home/hiroto/haxelib/flixel/5,6,2/assets/fonts/nokiafc22.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:keep @:font("/home/hiroto/haxelib/flixel/5,6,2/assets/fonts/monsterrat.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
...
@:keep @:noCompletion #if display private #end class __ASSET__assets_data_kenvector_future_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/kenvector_future.ttf"; name = "KenVector Future Regular"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__assets_data_kenvector_future_thin_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/kenvector_future_thin.ttf"; name = "KenVector Future Thin Regular"; super (); }}


#else

@:keep @:expose('__ASSET__assets_data_kenvector_future_ttf') @:noCompletion #if display private #end class __ASSET__assets_data_kenvector_future_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/data/kenvector_future.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "KenVector Future Regular"; super (); }}
@:keep @:expose('__ASSET__assets_data_kenvector_future_thin_ttf') @:noCompletion #if display private #end class __ASSET__assets_data_kenvector_future_thin_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/data/kenvector_future_thin.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "KenVector Future Thin Regular"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_data_kenvector_future_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_kenvector_future_ttf extends openfl.text.Font { public function new () { name = "KenVector Future Regular"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_data_kenvector_future_thin_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_kenvector_future_thin_ttf extends openfl.text.Font { public function new () { name = "KenVector Future Thin Regular"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__assets_data_kenvector_future_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_kenvector_future_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/kenvector_future.ttf"; name = "KenVector Future Regular"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_data_kenvector_future_thin_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_data_kenvector_future_thin_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/data/kenvector_future_thin.ttf"; name = "KenVector Future Thin Regular"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
